...
window.cash = (function () {
  ...
  function m(t) {
    "loading" !== o.readyState
      ? t()
      : o.addEventListener("DOMContentLoaded", t, { passive: true });
  }
  function g(t, e) {
    if (!t) return this;
  ...
  (function (i) {
    ...
    function n(t) {
      ...
      null !== e &&
        (g.show(t, e),
        "ontouchstart" in i &&
          (e.addEventListener("touchend", g.hide, { passive: true }),
          e.addEventListener("touchcancel", g.hide, { passive: true })),
        e.addEventListener("mouseup", g.hide, { passive: true }),
    ...
    (t.displayEffect = function (t) {
      "duration" in (t = t || {}) && (g.duration = t.duration),
        ...
        "ontouchstart" in i &&
          document.body.addEventListener("touchstart", n, { passive: true }),
      ...
      (t.attach = function (t) {
        "input" === t.tagName.toLowerCase() &&
          ...
          "ontouchstart" in i &&
            t.addEventListener("touchstart", n, { passive: true }),
